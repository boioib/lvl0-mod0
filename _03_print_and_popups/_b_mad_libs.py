...
if __name__ == '__main__':
    ...
    adjective = simpledialog.askstring(title='Task', prompt="Enter an adjective")
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title='Task', prompt="Enter a liquid")
    # Get the player to enter a body part
    body_part = simpledialog.askstring(title='Task',prompt="Enter a body part" )
    # Get the player to enter a verb
    verb = simpledialog.askstring(title='Task', prompt="Enter a verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title='Task', prompt="Enter a place")
